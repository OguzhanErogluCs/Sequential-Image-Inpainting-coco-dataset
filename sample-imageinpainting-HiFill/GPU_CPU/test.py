...
args.images = "/content/gdrive/My Drive/image_inpainting/sample-imageinpainting-HiFill/samples/testset" # input image directory
args.masks = "/content/gdrive/My Drive/image_inpainting/sample-imageinpainting-HiFill/samples/maskset" # input mask director
args.output_dir = '/content/gdrive/My Drive/image_inpainting/results' # output directory
...
with tf.Graph().as_default():
  with open("/content/gdrive/My Drive/image_inpainting/sample-imageinpainting-HiFill/GPU_CPU/pb/hifill.pb", "rb") as f:
